...
| profile | 固有差 | 所有しないもの |
| --- | --- | --- |
| PORTAL | Chat／IdleChatのWeb表示・入力、view／live／labのmode、Web renderer | Persona、会話、Task、Routine、deliveryの正本 |
...
| --- | --- |
| `portal-user` | chat、idlechat、tts、stt。実際の許可はview／live／labでさらに制限 |
