...
15. [Test Execution Policy](test-execution-policy.md) — Canonical Test Plan拡張、Impact選択、Shadow CI、receiptと保守的Full fallback
...
- [共通・module固有ルールの配置](rule-layout.md): 指示の正本、適用条件、配布と検証。
